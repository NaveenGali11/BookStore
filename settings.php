...
<html>
    ...
    <body>
        ...
        <div class="container-fluid" id="content" style="padding: 100px">
            <div class="row">
                <div class="col-lg-4" id="settings-container">
                    ...
                    <form action="settings_script.php" method="POST">
                        ...
                        <div class="form-group">
                            <input type="password" class="form-control" name="repnew_password" pattern=".{6,}" placeholder="Re-type New Password">
                        </div>
